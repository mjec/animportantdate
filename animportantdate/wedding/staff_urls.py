...
urlpatterns = [
    ...
    path('invitations/<int:event_id>', views.InviteesView.as_view(), name='invitations'),
    ...
    path(
        ...
        name=views.NeedToSendView.view_name_for_type(models.NeedToSend.THANKYOU_CARD)
    ),
    path(
        'invitations/',
        views.NeedToSendView.as_view(what=models.NeedToSend.INVITATION),
        name=views.NeedToSendView.view_name_for_type(models.NeedToSend.INVITATION)
    ),
    path(
        'save-the-date/',
        views.NeedToSendView.as_view(what=models.NeedToSend.SAVE_THE_DATE),
        name=views.NeedToSendView.view_name_for_type(models.NeedToSend.SAVE_THE_DATE)
    ),
